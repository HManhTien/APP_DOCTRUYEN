...
public class database extends SQLiteOpenHelper {
    ...
    public void addtaikhoan(taikhoan Taikhoan){
        ...
        value.put(TEN_TAI_KHOAN,Taikhoan.getmTaiKhoan());
        value.put(MAT_KHAU,Taikhoan.getmMatKhau());
        value.put(EMAIL,Taikhoan.getmEmaill());
        value.put(PHAN_QUYEN,Taikhoan.getmPhanQuyen());

        db.insert(TABLE_TAIKHOAN , null , value);
        db.close();
